...
if __name__== "__main__":
    from figures import *
    from yams_env import YamsEnvBinary
    ...
    env = YamsEnvBinary(3, 3, [Multiple(3, 15), Multiple(2, 5), Number(0), Number(1), Number(2), Chance()], rlalgo1.choose_action)
    ...
    test_episodes = [0, 1, 10, 100, 999]#1000, 2000, 5000, 8000, 10000, 11999, 30000, 49999, 99999]
    max_iter = 1000
